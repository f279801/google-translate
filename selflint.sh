...
GOOGLE_TRANSLATE_NG_PACKAGE_FILES="google-translate-backend.el google-translate-core-ui.el \
        google-translate-core.el google-translate-default-ui.el google-translate-pkg.el \
        google-translate-smooth-ui.el google-translate-tk.el google-translate.el"
